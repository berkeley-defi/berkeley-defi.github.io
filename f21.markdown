...
<table style="table-layout: fixed; font-size: 88%;">
  ...
  <tbody>
    <tr>
      ...
      <td>
         <ul style="margin-bottom: 0;">
           <li> <a href="https://youtu.be/UariFBhF-_o"> Lecture 1 Premiere </a> </li>
           <li> <a href="https://youtube.com/playlist?list=PLS01nW3RtgorojSlcoLBPRfoNGzQFywaL"> Lecture 1 Playlist </a> </li>
        </ul>
      </td>
    </tr>
    <tr>
