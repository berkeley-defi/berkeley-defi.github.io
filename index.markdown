...
04/15 | New ways to organize existing financial functions / DEX (decentralized exchanges) | | [An analysis of Uniswap markets](https://arxiv.org/abs/1911.03380) <br/> [Improved Price Oracles: Constant Function Market Makers](https://arxiv.org/abs/2003.10001) <br/> [DeFi and the Future of Finance](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3711777)
