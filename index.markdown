...
04/15 | New ways to organize existing financial functions / DEX (decentralized exchanges) | [Slides](https://drive.google.com/drive/folders/1gwrKYx-Q1LNUoRmDER_irkp8vVZ8L22C?usp=sharing) | [An analysis of Uniswap markets](https://arxiv.org/abs/1911.03380) <br/> [Improved Price Oracles: Constant Function Market Makers](https://arxiv.org/abs/2003.10001) 
